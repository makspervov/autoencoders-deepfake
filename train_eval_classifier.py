...
def train_and_evaluate_classifier(
    ...
    print("\n9. Saving best models to disk...")
    joblib.dump(scaler, os.path.join(output_dir, "scaler.pkl"))
    joblib.dump(xgb_clf, os.path.join(output_dir, "xgb_model.pkl"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="./results_supervised")
